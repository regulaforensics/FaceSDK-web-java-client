...
public class MatchRequest extends TransactionLabels {
  ...
  public MatchRequest tag(@javax.annotation.Nullable String tag) {
    this.tag = tag;
    return this;
  }
  ...
  public MatchRequest images(@javax.annotation.Nonnull List<MatchImage> images) {
    this.images = images;
    return this;
  }
  ...
  public MatchRequest outputImageParams(
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tag, images, outputImageParams, super.hashCode());
  }
  ...
  static {
    ...
    openapiFields =
        new HashSet<String>(Arrays.asList("tenant", "env", "tag", "images", "outputImageParams"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!MatchRequest.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in MatchRequest is not found in the empty JSON string",
                MatchRequest.openapiRequiredFields.toString()));
      }
    }
