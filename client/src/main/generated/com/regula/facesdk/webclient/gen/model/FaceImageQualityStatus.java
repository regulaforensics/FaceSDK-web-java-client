...
/**
 * The processing status returned for each quality characteristic, see the [FaceImageQualityStatus
 * enum](https://docs.regulaforensics.com/develop/face-sdk/web-service/development/enums/face-image-quality-status/).
 */
...
public enum FaceImageQualityStatus {
  ...
  public static class Adapter extends TypeAdapter<FaceImageQualityStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final FaceImageQualityStatus enumeration)
        throws IOException {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    FaceImageQualityStatus.fromValue(value);
  }
}
