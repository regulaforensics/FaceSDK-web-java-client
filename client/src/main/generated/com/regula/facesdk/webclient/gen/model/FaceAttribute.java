...
/**
 * The name of the attribute. For definitions, see the [FaceAttribute
 * enum](https://docs.regulaforensics.com/develop/face-sdk/web-service/development/enums/face-attribute/).
 */
...
public enum FaceAttribute {
  ...
  public static class Adapter extends TypeAdapter<FaceAttribute> {
    @Override
    public void write(final JsonWriter jsonWriter, final FaceAttribute enumeration)
        throws IOException {
