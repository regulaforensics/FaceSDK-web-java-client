...
public class MatchApi {
   ...
   * </table>
   */
  public okhttp3.Call detectCall(
      @javax.annotation.Nonnull DetectRequest detectRequest,
  ...
  private okhttp3.Call detectValidateBeforeCall(
    ...
    return detectCall(detectRequest, xRequestID, _callback);
  }

  /**
   * detect and check quality Use the POST &#x60;api/detect&#x60; endpoint to analyze images,
   * recognize faces in them, and return cropped and aligned portraits of the detected people. The
   * Face Detection feature lets you additionally: - **Check face image quality**: Assess whether a
   * portrait meets certain standards, for example, ICAO, Schengen visa, USA visa. To perform image
   * quality check, use the &#x60;processParam.quality&#x60; field. For the list of assessed
   * characteristics, see the [Face Image Quality Characteristics
   * page](https://docs.regulaforensics.com/develop/face-sdk/web-service/development/usage/face-detection/face-image-quality-check/).
   * - **Evaluate face attributes**: Estimate the age range of a person; check whether the eyes are
   * occluded, closed, or open; detect a facial expression or smile; see if there are glasses,
   * sunglasses, head coverage, medical mask, etc. To evaluate attributes, add the
   * &#x60;processParam.attributes&#x60; field. For the list of assessed attributes, see the
   * [Attributes List
   * page](https://docs.regulaforensics.com/develop/face-sdk/web-service/development/usage/face-detection/attributes-detection/).
   * You can perform Face Detection in two ways: - By adding parameters manually. In this case, the
   * configuration is not saved and you will need to add all the necessary parameters to each
   * request. - By a processing &#x60;scenario&#x60; that includes certain parameters. You can use
   * predefined scenarios or add custom ones. For detailed information about scenarios, refer to the
   * [Scenarios
   * page](https://docs.regulaforensics.com/develop/face-sdk/web-service/development/usage/face-detection/scenarios/).
   *
   * @param detectRequest (required)
   * @param xRequestID Request header label. (optional)
   ...
   * </table>
   */
  public ApiResponse<DetectResponse> detectWithHttpInfo(
      @javax.annotation.Nonnull DetectRequest detectRequest,
      @javax.annotation.Nullable String xRequestID)
      throws ApiException {
  ...
  /**
   * detect and check quality (asynchronously) Use the POST &#x60;api/detect&#x60; endpoint to
   * analyze images, recognize faces in them, and return cropped and aligned portraits of the
   * detected people. The Face Detection feature lets you additionally: - **Check face image
   * quality**: Assess whether a portrait meets certain standards, for example, ICAO, Schengen visa,
   * USA visa. To perform image quality check, use the &#x60;processParam.quality&#x60; field. For
   * the list of assessed characteristics, see the [Face Image Quality Characteristics
   * page](https://docs.regulaforensics.com/develop/face-sdk/web-service/development/usage/face-detection/face-image-quality-check/).
   * - **Evaluate face attributes**: Estimate the age range of a person; check whether the eyes are
   * occluded, closed, or open; detect a facial expression or smile; see if there are glasses,
   * sunglasses, head coverage, medical mask, etc. To evaluate attributes, add the
  ...
  public okhttp3.Call detectAsync(
      @javax.annotation.Nonnull DetectRequest detectRequest,
      @javax.annotation.Nullable String xRequestID,
      final ApiCallback<DetectResponse> _callback)
      throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call matchCall(
      @javax.annotation.Nonnull MatchRequest matchRequest,
      @javax.annotation.Nullable String xRequestID,
      final ApiCallback _callback)
      throws ApiException {
    String basePath = null;
  ...
  private okhttp3.Call matchValidateBeforeCall(
    ...
    return matchCall(matchRequest, xRequestID, _callback);
  }
   ...
   * </table>
   */
  public ApiResponse<MatchResponse> matchWithHttpInfo(
      @javax.annotation.Nonnull MatchRequest matchRequest,
      @javax.annotation.Nullable String xRequestID)
      throws ApiException {
  ...
  public okhttp3.Call matchAsync(
      @javax.annotation.Nonnull MatchRequest matchRequest,
      @javax.annotation.Nullable String xRequestID,
      final ApiCallback<MatchResponse> _callback)
      throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call matchAndSearchCall(
      @javax.annotation.Nonnull MatchAndSearchRequest matchAndSearchRequest,
      @javax.annotation.Nullable String xRequestID,
      final ApiCallback _callback)
      throws ApiException {
    String basePath = null;
  ...
  @SuppressWarnings("rawtypes")
  private okhttp3.Call matchAndSearchValidateBeforeCall(
      @javax.annotation.Nonnull MatchAndSearchRequest matchAndSearchRequest,
      @javax.annotation.Nullable String xRequestID,
      final ApiCallback _callback)
      throws ApiException {
    ...
    if (matchAndSearchRequest == null) {
      throw new ApiException(
          "Missing the required parameter 'matchAndSearchRequest' when calling matchAndSearch(Async)");
    }

    return matchAndSearchCall(matchAndSearchRequest, xRequestID, _callback);
  }

  /**
   * match and search (1:1 + 1:N) To compare several images from a document and look up a person in
   * the database in one request, use POST &#x60;/api/match_and_search&#x60;. In this case, the
   * calculation of the descriptor will be performed only once, as opposed to using two requests for
   * the same operation. At least two photos are required. If, after processing two or more photos,
   * only one face is detected across them, the match step is skipped, and only the search is
   * carried out.
   *
   * @param matchAndSearchRequest (required)
   * @param xRequestID Request header label. (optional)
  ...
  public MatchAndSearchResponse matchAndSearch(
      ...
      @javax.annotation.Nullable String xRequestID)
      throws ApiException {
    ApiResponse<MatchAndSearchResponse> localVarResp =
        matchAndSearchWithHttpInfo(matchAndSearchRequest, xRequestID);
    return localVarResp.getData();
  }
   ...
   * </table>
   */
  public ApiResponse<MatchAndSearchResponse> matchAndSearchWithHttpInfo(
      @javax.annotation.Nonnull MatchAndSearchRequest matchAndSearchRequest,
      @javax.annotation.Nullable String xRequestID)
      throws ApiException {
    okhttp3.Call localVarCall =
        matchAndSearchValidateBeforeCall(matchAndSearchRequest, xRequestID, null);
    Type localVarReturnType = new TypeToken<MatchAndSearchResponse>() {}.getType();
    return localVarApiClient.execute(localVarCall, localVarReturnType);
  }

  /**
   * match and search (1:1 + 1:N) (asynchronously) To compare several images from a document and
   * look up a person in the database in one request, use POST &#x60;/api/match_and_search&#x60;. In
   * this case, the calculation of the descriptor will be performed only once, as opposed to using
   * two requests for the same operation. At least two photos are required. If, after processing two
   * or more photos, only one face is detected across them, the match step is skipped, and only the
   ...
   * </table>
   */
  public okhttp3.Call matchAndSearchAsync(
      @javax.annotation.Nonnull MatchAndSearchRequest matchAndSearchRequest,
      @javax.annotation.Nullable String xRequestID,
      final ApiCallback<MatchAndSearchResponse> _callback)
      throws ApiException {

    okhttp3.Call localVarCall =
        matchAndSearchValidateBeforeCall(matchAndSearchRequest, xRequestID, _callback);
    Type localVarReturnType = new TypeToken<MatchAndSearchResponse>() {}.getType();
    localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
    return localVarCall;
  }
