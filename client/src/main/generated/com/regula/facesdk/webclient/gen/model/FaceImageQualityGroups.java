...
/**
 * The group ID of the characteristic, see the [FaceImageQualityGroups
 * enum](https://docs.regulaforensics.com/develop/face-sdk/web-service/development/enums/face-image-quality-groups/)
 * for details.
 */
...
public enum FaceImageQualityGroups {
  ...
  public static class Adapter extends TypeAdapter<FaceImageQualityGroups> {
    @Override
    public void write(final JsonWriter jsonWriter, final FaceImageQualityGroups enumeration)
        throws IOException {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    FaceImageQualityGroups.fromValue(value);
  }
}
