 ...
 */
@ApiModel(description = "The detection results.")
...
public class DetectResult {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The array of performed checks.")
  ...
  **/
  ...
  public DetectResult scenario(String scenario) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The face detection scenario that was set in the `processParam.scenario` field of the request.")
  ...
  public DetectResult elapsedTime(Float elapsedTime) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0.8479356", value = "Server processing time, ms. Does not include the time taken to receive the request or deliver the response.")
