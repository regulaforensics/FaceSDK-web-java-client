...
import com.regula.facesdk.webclient.gen.model.GroupsGroupId;
...
public class GroupApi {
  ...
  public okhttp3.Call updateGroupCall(
      BigDecimal groupId, GroupsGroupId body, final ApiCallback _callback) throws ApiException {
  ...
  private okhttp3.Call updateGroupValidateBeforeCall(
    ...
    if (body == null) {
      throw new ApiException(
          "Missing the required parameter 'body' when calling updateGroup(Async)");
    }

    okhttp3.Call localVarCall = updateGroupCall(groupId, body, _callback);
    return localVarCall;
  }
   ...
   * </table>
   */
  public void updateGroup(BigDecimal groupId, GroupsGroupId body) throws ApiException {
   ...
   * </table>
   */
  public ApiResponse<Void> updateGroupWithHttpInfo(BigDecimal groupId, GroupsGroupId body)
      throws ApiException {
    okhttp3.Call localVarCall = updateGroupValidateBeforeCall(groupId, body, null);
    return localVarApiClient.execute(localVarCall);
  }
  ...
  public okhttp3.Call updateGroupAsync(
      BigDecimal groupId, GroupsGroupId body, final ApiCallback<Void> _callback)
      throws ApiException {

    okhttp3.Call localVarCall = updateGroupValidateBeforeCall(groupId, body, _callback);
    localVarApiClient.executeAsync(localVarCall, _callback);
    return localVarCall;
  }
  /**
