...
public class SearchApi {
     ...
     * @param withImages When enabled, the response includes Base64-encoded images of matched persons. Each entry in the &#x60;persons&#x60; array contains an &#x60;images&#x60; field with image IDs and content. If omitted or set to false, images are excluded. (optional)
     ...
     */
    public okhttp3.Call searchCall(SearchRequest searchRequest, String xRequestID, Boolean withImages, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call searchValidateBeforeCall(SearchRequest searchRequest, String xRequestID, Boolean withImages, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = searchCall(searchRequest, xRequestID, withImages, _callback);
        return localVarCall;
    ...
    public SearchResult search(SearchRequest searchRequest, String xRequestID, Boolean withImages) throws ApiException {
        ApiResponse<SearchResult> localVarResp = searchWithHttpInfo(searchRequest, xRequestID, withImages);
     ...
     */
    public ApiResponse<SearchResult> searchWithHttpInfo(SearchRequest searchRequest, String xRequestID, Boolean withImages) throws ApiException {
        okhttp3.Call localVarCall = searchValidateBeforeCall(searchRequest, xRequestID, withImages, null);
     ...
     */
    public okhttp3.Call searchAsync(SearchRequest searchRequest, String xRequestID, Boolean withImages, final ApiCallback<SearchResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchValidateBeforeCall(searchRequest, xRequestID, withImages, _callback);
        Type localVarReturnType = new TypeToken<SearchResult>(){}.getType();
