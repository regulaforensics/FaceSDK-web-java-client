...
import com.regula.facesdk.webclient.gen.model.InlineObject;
...
public class PersonApi {
  ...
  public okhttp3.Call addImageToPersonCall(
      BigDecimal personId, InlineObject inlineObject, final ApiCallback _callback)
      throws ApiException {
    ...
    final String[] localVarAccepts = {"applications/json", "application/json"};
  ...
  private okhttp3.Call addImageToPersonValidateBeforeCall(
    ...
    if (inlineObject == null) {
      throw new ApiException(
          "Missing the required parameter 'inlineObject' when calling addImageToPerson(Async)");
    }

    okhttp3.Call localVarCall = addImageToPersonCall(personId, inlineObject, _callback);
    return localVarCall;
  }
   ...
   * </table>
   */
  public Image addImageToPerson(BigDecimal personId, InlineObject inlineObject)
      throws ApiException {
    ApiResponse<Image> localVarResp = addImageToPersonWithHttpInfo(personId, inlineObject);
   ...
   * </table>
   */
  public ApiResponse<Image> addImageToPersonWithHttpInfo(
      BigDecimal personId, InlineObject inlineObject) throws ApiException {
    okhttp3.Call localVarCall = addImageToPersonValidateBeforeCall(personId, inlineObject, null);
  ...
  public okhttp3.Call addImageToPersonAsync(
      BigDecimal personId, InlineObject inlineObject, final ApiCallback<Image> _callback)
      throws ApiException {

    okhttp3.Call localVarCall =
        addImageToPersonValidateBeforeCall(personId, inlineObject, _callback);
    Type localVarReturnType = new TypeToken<Image>() {}.getType();
  ...
  public okhttp3.Call updatePersonCall(
      BigDecimal personId, PersonFields personFields, final ApiCallback _callback)
      throws ApiException {
    Object localVarPostBody = personFields;
  ...
  private okhttp3.Call updatePersonValidateBeforeCall(
    ...
    if (personFields == null) {
      throw new ApiException(
          "Missing the required parameter 'personFields' when calling updatePerson(Async)");
    }
   ...
   * </table>
   */
  public ApiResponse<Void> updatePersonWithHttpInfo(BigDecimal personId, PersonFields personFields)
      throws ApiException {
  ...
  public okhttp3.Call updatePersonAsync(
      BigDecimal personId, PersonFields personFields, final ApiCallback<Void> _callback)
      throws ApiException {
