...
public class Liveness20Api {
     ...
     */
    public okhttp3.Call deleteLivenessTransactionCall(UUID transactionId, String tag, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call deleteLivenessTransactionValidateBeforeCall(UUID transactionId, String tag, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'transactionId' is set
        if (transactionId == null) {
            throw new ApiException("Missing the required parameter 'transactionId' when calling deleteLivenessTransaction(Async)");
        }
        
        // verify the required parameter 'tag' is set
        if (tag == null) {
            throw new ApiException("Missing the required parameter 'tag' when calling deleteLivenessTransaction(Async)");
        }
        

        okhttp3.Call localVarCall = deleteLivenessTransactionCall(transactionId, tag, _callback);
        return localVarCall;
     ...
     */
    public void deleteLivenessTransaction(UUID transactionId, String tag) throws ApiException {
     ...
     */
    public ApiResponse<Void> deleteLivenessTransactionWithHttpInfo(UUID transactionId, String tag) throws ApiException {
        okhttp3.Call localVarCall = deleteLivenessTransactionValidateBeforeCall(transactionId, tag, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * delete liveness transaction (asynchronously)
     * This endpoint deletes a liveness transaction based on either the specified &#x60;tag&#x60; or &#x60;transactionId&#x60;. At least one of the parameters must be provided for the operation to be valid.
     * @param transactionId ID of the current liveness transaction. (required)
     * @param tag A unique tag associated with a liveness transaction session. Used to identify and delete the corresponding transaction. (required)
     ...
     */
    public okhttp3.Call deleteLivenessTransactionAsync(UUID transactionId, String tag, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteLivenessTransactionValidateBeforeCall(transactionId, tag, _callback);
