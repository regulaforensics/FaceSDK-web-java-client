...
public class RecognizeImage {
  ...
  **/
  ...
  public RecognizeImage content(String content) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Base64-encoded image. Returned only if `withImages` is set to true in the request.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, recognizeImage.id) &&
        Objects.equals(this.content, recognizeImage.content) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, content, contentType, createdAt, updatedAt, path, url, metadata, similarity, distance);
  }
