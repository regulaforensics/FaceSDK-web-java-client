...
public class FacesResponse {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "[\"x\",\"y\",\"width\",\"height\"]", value = "Rectangular area of the detected face. First element - X-axis coordinate. Second element - Y-axis coordinate. (X, Y) - left top point. Third element - rectangular width. Fourth element - rectangular height.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(faceIndex, landmarks, roi, Arrays.hashCode(thumbnail), persons, rotationAngle);
  }
