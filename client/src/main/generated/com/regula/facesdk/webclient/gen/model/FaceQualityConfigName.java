...
/**
 * The name of the characteristic. For definitions, see the [FaceQualityConfigName
 * enum](https://docs.regulaforensics.com/develop/face-sdk/web-service/development/enums/face-quality-config-name/).
 */
...
public enum FaceQualityConfigName {
  ...
  public static class Adapter extends TypeAdapter<FaceQualityConfigName> {
    @Override
    public void write(final JsonWriter jsonWriter, final FaceQualityConfigName enumeration)
        throws IOException {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    FaceQualityConfigName.fromValue(value);
  }
}
