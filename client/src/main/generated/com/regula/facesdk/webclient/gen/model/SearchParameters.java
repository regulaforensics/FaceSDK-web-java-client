...
public class SearchParameters {
  ...
  public SearchParameters createPerson(
  ...
  public SearchParameters groupIds(@javax.annotation.Nullable List<UUID> groupIds) {
  ...
  public SearchParameters filter(@javax.annotation.Nullable FilterSearchRequest filter) {
    this.filter = filter;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createPerson, searchParameters.createPerson)
        ...
        && Objects.equals(this.filter, searchParameters.filter);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createPerson, groupIds, filter);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("createPerson", "groupIds", "filter"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    if (jsonElement == null) {
      if (!SearchParameters.openapiRequiredFields
          .isEmpty()) { // has required fields but JSON element is null
        throw new IllegalArgumentException(
            String.format(
                "The required field(s) %s in SearchParameters is not found in the empty JSON string",
                SearchParameters.openapiRequiredFields.toString()));
      }
    }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
      ...
      return (TypeAdapter<T>)
          new TypeAdapter<SearchParameters>() {
            @Override
