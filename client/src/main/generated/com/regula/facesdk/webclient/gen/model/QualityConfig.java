 ...
 */
@ApiModel(description = "The configuration that defines the list of returned quality check characteristics. For every characteristic, includes name, range, unit.")
