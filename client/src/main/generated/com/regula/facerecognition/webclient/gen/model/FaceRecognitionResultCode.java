 ...
 */
@JsonAdapter(FaceRecognitionResultCode.Adapter.class)
public enum FaceRecognitionResultCode {
  ...
  FaceRecognitionResultCode(Integer value) {
    this.value = value;
  }
  ...
  public static FaceRecognitionResultCode fromValue(Integer value) {
    for (FaceRecognitionResultCode b : FaceRecognitionResultCode.values()) {
  ...
  public static class Adapter extends TypeAdapter<FaceRecognitionResultCode> {
    @Override
    public void write(final JsonWriter jsonWriter, final FaceRecognitionResultCode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FaceRecognitionResultCode read(final JsonReader jsonReader) throws IOException {
      Integer value = jsonReader.nextInt();
      return FaceRecognitionResultCode.fromValue(value);
    }
  }
}
