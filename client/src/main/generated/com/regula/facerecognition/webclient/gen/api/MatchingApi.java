...
public class MatchingApi {
     ...
     */
    public okhttp3.Call compareCall(CompareRequest compareRequest, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call compareValidateBeforeCall(CompareRequest compareRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'compareRequest' is set
        if (compareRequest == null) {
            throw new ApiException("Missing the required parameter 'compareRequest' when calling compare(Async)");
        }
     ...
     */
    public ApiResponse<CompareResponse> compareWithHttpInfo(CompareRequest compareRequest) throws ApiException {
     ...
     */
    public okhttp3.Call compareAsync(CompareRequest compareRequest, final ApiCallback<CompareResponse> _callback) throws ApiException {
