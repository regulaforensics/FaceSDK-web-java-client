...
public class PersonApi extends com.regula.facesdk.webclient.gen.api.PersonApi {
  ...
  public AddImageToPersonResponse addImageToPerson(
      UUID personId, AddImageToPersonRequest imageFields, String xRequestID) throws ApiException {
    return super.addImageToPerson(personId, imageFields, xRequestID);
  }

  public AddImageToPersonResponse addImageToPerson(
      UUID personId, AddImageToPersonRequest imageFields) throws ApiException {
    return addImageToPerson(personId, imageFields, "");
  }

  public void deleteImageOfPerson(String imageId, UUID personId, String xRequestID)
      throws ApiException {
    super.deleteImageOfPerson(personId, imageId, xRequestID);
  }
  ...
  public GroupPage getAllGroupsByPersonId(
      Integer page, Integer size, UUID personId, String xRequestID) throws ApiException {
    return super.getAllGroupsByPersonId(personId, xRequestID, page, size);
  }

  public GroupPage getAllGroupsByPersonId(Integer page, Integer size, UUID personId)
      throws ApiException {
  ...
  public ImagePage getAllImagesByPersonId(
      Integer page, Integer size, UUID personId, String xRequestID) throws ApiException {
    return super.getAllImagesByPersonId(personId, xRequestID, page, size);
  }

  public ImagePage getAllImagesByPersonId(Integer page, Integer size, UUID personId)
      throws ApiException {
    return this.getAllImagesByPersonId(page, size, personId, "");
  }

  public File getImageOfPerson(String imageId, UUID personId, String xRequestID)
      throws ApiException {
    return super.getImageOfPerson(personId, imageId, xRequestID);
  }
  ...
  public void updatePerson(UUID personId, PersonToUpdateFields personFields, String xRequestID)
      throws ApiException {
    if (personFields.getMetadata() == null) personFields.setMetadata(new HashMap<String, Object>());
