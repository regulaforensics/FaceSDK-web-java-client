...
public class GroupApi extends com.regula.facesdk.webclient.gen.api.GroupApi {
  ...
  public Group createGroup(GroupToCreate groupToCreate, String xRequestID) throws ApiException {
    if (groupToCreate.getMetadata() == null)
      groupToCreate.setMetadata(new HashMap<String, Object>());
  ...
  public GroupPage getAllGroups(Integer page, Integer size, String xRequestID) throws ApiException {
    return super.getAllGroups(xRequestID, page, size);
  }
  ...
  public PersonsPage getAllPersonsByGroupId(
      Integer page, Integer size, UUID groupId, String xRequestID) throws ApiException {
    return super.getAllPersonsByGroupId(groupId, xRequestID, page, size);
  }

  public PersonsPage getAllPersonsByGroupId(Integer page, Integer size, UUID groupId)
      throws ApiException {
    return super.getAllPersonsByGroupId(groupId, "", page, size);
  }
  ...
  public void updateGroup(UUID groupId, GroupToCreate groupToCreate, String xRequestID)
      throws ApiException {
    if (groupToCreate.getMetadata() == null)
      groupToCreate.setMetadata(new HashMap<String, Object>());
  ...
  public void updatePersonsInGroup(UUID groupId, UpdateGroup updateGroup, String xRequestID)
      throws ApiException {
