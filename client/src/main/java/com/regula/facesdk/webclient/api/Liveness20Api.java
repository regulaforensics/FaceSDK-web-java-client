...
public class Liveness20Api extends com.regula.facesdk.webclient.gen.api.Liveness20Api {
  ...
  public okhttp3.Call getLivenessTransactionInfoCall(
  ...
  public ApiResponse<TransactionInfo> getLivenessTransactionInfoWithHttpInfo(UUID transactionId)
      throws ApiException {
    return super.getLivenessTransactionInfoWithHttpInfo(transactionId);
  }

  public okhttp3.Call getLivenessTransactionInfoAsync(
      UUID transactionId, final ApiCallback<TransactionInfo> _callback) throws ApiException {
    return super.getLivenessTransactionInfoCall(transactionId, _callback);
  }
}
